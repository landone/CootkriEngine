...
public:
	...
	//Send a screen size change event w/o changing size
	void refreshScreenSize();
	//Current rate of frames per second
	static float getFPS();
	//Time that has passed for this frame
...
private:
	...
	float screenWidth = 2.0f;//Not in pixels, but screen coordinates
